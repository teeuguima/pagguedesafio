        ...
        <div class="box-categorias d-flex">
          <div class="pad-box">
            ...
            <p class="describe-box">
              Cadastre as categorias destinadas a seus produtos
            </p>
            <div class="d-flex">
              <div>
          ...
          <div class="table-categorias">
            ...
            <p class="describe-box" id="describe-table">
              Abaixo a lista das categorias cadastradas
            </p>
              ...
              <table class="table">
                ...
                <tbody>
                  <tr v-for="(categoria, index) in categorias" :key="index">
                    ...
                    <td style="cursor: pointer" @click="remover(index)">
